    ...
    *,
    ...
    return {
        ...
        "business_takeaways": [
            ...
            "The baseline model improves valid log loss over retrieval-order ranking on the smoke fixture, but not enough data exists to claim stable ranking gains.",
...
def build_report_markdown(*, project: dict[str, Any], inputs: dict[str, Any], executive_summary: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"- Comparison view: logistic baseline changed valid accuracy by {ranker_compare_metrics['metric_deltas']['classification.accuracy']:.3f} and valid log loss by {ranker_compare_metrics['metric_deltas']['classification.log_loss']:.3f} versus retrieval-order ranking.",
